...
SELECT ingredient_name, branch_name, supplier_name, date_and_time, quantity, price, quantity * price AS total_cost
...
ORDER BY ingredient_name, branch_name, supplier_name
;
